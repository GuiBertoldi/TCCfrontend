...
export default function SessionList() {
  ...
  const columns = [
    { title: "Número da Consulta", dataIndex: "idSession", key: "idSession" },
    { title: "Data da Consulta",     dataIndex: "sessionDate", key: "sessionDate" },
    { title: "Psicólogo(a)",         dataIndex: "psychologist", key: "psychologist" },
    {
      key: "edit",
      render: (_, session) => (
        <Button
